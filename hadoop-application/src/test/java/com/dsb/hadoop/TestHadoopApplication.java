...
//    @Before
    ...
    @Test
    public void test3(){
        testIConnectionController.create(UUID.randomUUID().toString(),"UBMCZZDPMXHOFVXBKYPB|UbVExcLt0RmS0Je8TBUfUr1AiHRllkaktC6osRox","");
    }
    ...
    public void test1() {
        try {
            ...
            System.out.println(String.format("hdfs:%s", hdfsFilePath));
            //创建输出流
